...
# ================== EEG 通道（BCICIV-2a：22 EEG，不含 EOG） ==================
# ⚠️ 关键：这里的顺序必须与 LoadData.load_data_2a() 里从 .mat 取出的前 22 列顺序一致。
# BCICIV-2a 常用/默认的 22 EEG 顺序为：
...
# ================== 近似 10-20 头皮拓扑坐标（用于构图） ==================
# 这里给出一个“网格化近似坐标”，用于 build_eeg_2a_adj() 的距离阈值连边。
# 你可以根据需要调整 connect_thresh（默认 1.5）。
CHAN_POS_2A = {
    "Fz":  (0, 3),

    "FC3": (1, 1), "FC1": (1, 2), "FCz": (1, 3), "FC2": (1, 4), "FC4": (1, 5),

    "C5":  (2, 0), "C3":  (2, 1), "C1":  (2, 2), "Cz":  (2, 3),
    "C2":  (2, 4), "C4":  (2, 5), "C6":  (2, 6),

    "CP3": (3, 1), "CP1": (3, 2), "CPz": (3, 3), "CP2": (3, 4), "CP4": (3, 5),

    "P1":  (4, 2), "Pz":  (4, 3), "P2":  (4, 4),
